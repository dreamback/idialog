...
~function($, window, undefined) {
    ...
    dialog.fn = dialog.prototype = {
        ...
        createHTML: function() {
            ...
            if(this._btn) html+='<div class="wrap-btn"></div>';
            ...
            this.$wrapBtn = this.$dialog.find('.wrap-btn');
        ...
        btn: function(btns){
            var input, that = this;
            if(!btns){
                $.each(this._btn, function(){
                    input = document.createElement('input');
                    input.type = 'button';
                    input.value = this.val;
                    input.val = this.val;
                    input.disabled = this.disabled === true ? 'disabled' : '';
                    input.onclick = this.click;
                    that.$wrapBtn.append(input);
                });
            }else{
