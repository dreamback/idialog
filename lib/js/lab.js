        ...
        iDialog({
            ...
            show: function() {
                if (!-[1,] && !window.XMLHttpRequest) {
                    this.$dialog[0].style.setExpression('top', 'eval(document.documentElement.scrollTop+document.documentElement.clientHeight-this.offsetHeight-20)');
                    this.$dialog[0].style.setExpression('left', 'eval(document.documentElement.scrollLeft+document.documentElement.clientWidth-this.offsetWidth-20)');
